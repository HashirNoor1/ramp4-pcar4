import { Et as e, Tt as t, V as n, h as r, m as i } from "./main-DLsd1Ve5.js";
...
var N = { class: "flex justify-end mb-20" }, P = ["disabled", "animation"], F = { class: "button-text" }, I = /* @__PURE__ */ a(/* @__PURE__ */ m({
	...
	setup(e, { expose: t, emit: n }) {
		...
		let F = (e) => {
			...
			I(e.target.value), a("link", e.target.value, _), y.value = !1;
		}, $ = (e, t) => {
			a(e ? "select" : "update:modelValue", t.target.value);
		}, Ce = (e) => {
			a("nested", e.target.checked);
		}, we = (e) => {
			F(e.target.value), a("link", e.target.value, _), S.value = !1;
		}, Te = () => {

...
var lo = class e {
	...
	async createMap(e, t) {
		...
		}), this._basemapStore = i, e.labelsDefault && (this.labelsDefault.visible = e.labelsDefault.visible), this.esriMap = T(await K.Map({})), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
	}
	destroyMap() {
...
var So = class extends X {
	...
	extractLayerMetadata() {
		...
		this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? Nt.fromESRI(e.fullExtent, this.id + "_extent"), this.fields = T(e.fields.slice()).map((e) => ({
			name: e.name,
			alias: e.alias,
			type: e.type,
			length: e.length
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-42UrghC1.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-DlU0_9rg.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-BR8w1Yka.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-CQZgbgzx.js"),
	"../fixtures/details/index.ts": () => import("./details-eofS0VPN.js"),
	"../fixtures/draw/index.ts": () => import("./draw-FvgLVSh9.js"),
	"../fixtures/export/index.ts": () => import("./export-BWteok1g.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-tqARUBvX.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-0_9jmPim.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-DGwlOtEC.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-BXiI6mPp.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-DnFqgVbh.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-Dvy0BWAe.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-DQWpribf.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-BJX2jEBN.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-CJRsUplS.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-GT3JN8do.js"),
	"../fixtures/grid/index.ts": () => import("./grid-gNh5fVPC.js"),
	"../fixtures/help/index.ts": () => import("./help-C-_Lj4lv.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-BEqPLPzO.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-Bw23PNgp.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-BN7F6GKE.js"),
	"../fixtures/legend/index.ts": () => import("./legend-wmIoxDdj.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-zYWHrox_.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-CGGOnD1f.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-D1DAP69-.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-BiWlq0ko.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-CiWN6RLH.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-CI7lMq1_.js"),
	"../fixtures/settings/index.ts": () => import("./settings-Bl-vDbDg.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-CusvFZ17.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-DVF87n2X.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-BBe3W7O4.js")
}), Ss = class extends X {
	constructor(e) {
		super(e);
	}
...
var Os = /* @__PURE__ */ n(Es, [["render", Ds], ["__scopeId", "data-v-a3c61802"]]), ks = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-CQkApPPg.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-Dq5-_7lK.js"),
	"../fixtures/export/screen.vue": () => import("./screen-Bnf-FOgB.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-CR23NYOv.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-Bq9xV4mC.js"),
	"../fixtures/help/screen.vue": () => import("./screen-CfI1p5vz.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-B2JN610m.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-LprXa2vt.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-BiTDLOoN.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-D1OKd7gk.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-B6M-K-7E.js")
}), As = class extends X {
	id;
	screens;
	loadedScreens = [];
...
console.info(`RAMP v${{
	...
	minor: "21",
	patch: "0-beta",
	timestamp: "Tue May 12 09:59:05 2026 -0400",
	hash: "e77b8594dedee000ce70fda5bd03b036d09b3009"
}.major}.${{
	major: "4",
	minor: "21",
	patch: "0-beta",
